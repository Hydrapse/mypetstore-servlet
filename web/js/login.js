    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState==4 && xhr.status==200) {
            ...
            if (arr[0] == "false") {
                ...
                window.location.href = "viewLoginForm";
            }
                ...
                if(arr[0] === "history-cart-true-current-notEmpty"){
                    ...
                    if(confirm("Do you want to cover the current-shopping-cart with the historical-shopping-cart ?")){
                        xhrTemp.open("GET", "afterLogin?handleCart=true");
                        xhrTemp.send(null);
                        flag = true;
                    }
                }
                ...
                if(info === "checkout"){
                    if(flag){
                        ...
                        window.location.href = "viewOrderForm";
                    }
...
$(function () {
    ...
    $("#username-reg").blur(function () {
        ...
        var para = "checkUsernameUnused?username-reg=" + username;
