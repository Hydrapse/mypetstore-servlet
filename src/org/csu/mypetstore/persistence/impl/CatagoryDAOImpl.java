...
public class CatagoryDAOImpl implements CategoryDAO {
    ...
    private static final String GET_CATEGORY = "SELECT CATID AS categoryId, NAME, DESCN AS description FROM CATEGORY " +
            "WHERE CATID = ? ";
...
//        CatagoryDAOImpl impl = new CatagoryDAOImpl();
//        List<Category> ls = impl.getCategoryList();
//        for(Category c : ls){
//            System.out.println(c.getDescription());
//        }
//        System.out.println(impl.getCategory("BIRDS").getDescription());
//    }
}
